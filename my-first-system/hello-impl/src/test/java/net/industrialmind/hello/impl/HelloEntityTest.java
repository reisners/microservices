 ...
 */
package net.industrialmind.hello.impl;
...
import net.industrialmind.hello.impl.HelloCommand.Hello;
import net.industrialmind.hello.impl.HelloCommand.UseGreetingMessage;
import net.industrialmind.hello.impl.HelloEvent.GreetingMessageChanged;
